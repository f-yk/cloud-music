					...
					<view class="detail-like-list">
						...
						<view class="detail-like-item" v-for="(item,index) in songSimi" :key="index" @tap="handleToSimi(item.id)">
							...
							<view class="detail-like-song">
								<view>{{item.name}}</view>
								<view>
									<image v-if="item.privilege.flag > 60 && item.privilege.flag < 70" src="http://43.143.90.184:8080/dujia.png" mode=""></image>
									<image v-if="item.privilege.maxbr == 999000" src="http://43.143.90.184:8080/sq.png" mode=""></image>
...
<style scoped>
	...
	.detail-play{ width:580rpx; height:580rpx; background:url(http://43.143.90.184:8080/disc.png); background-size:cover; margin:210rpx auto 44rpx auto; position: relative;}
	...
	margin:auto; top:-170rpx; background:url(http://43.143.90.184:8080/needle.png); background-size:cover;
